...
import roshanmanjaly.cs301.cs.wm.edu.amazebyroshanmanjaly.ui.generation.BSPBranch;
import roshanmanjaly.cs301.cs.wm.edu.amazebyroshanmanjaly.ui.generation.BSPLeaf;
import roshanmanjaly.cs301.cs.wm.edu.amazebyroshanmanjaly.ui.generation.BSPNode;
import roshanmanjaly.cs301.cs.wm.edu.amazebyroshanmanjaly.ui.generation.Cells;
import roshanmanjaly.cs301.cs.wm.edu.amazebyroshanmanjaly.ui.generation.Distance;
...
import roshanmanjaly.cs301.cs.wm.edu.amazebyroshanmanjaly.ui.generation.Seg;
...
public class MazeFileReader {
	...
	private static Seg readSegment(Element eElement, int number, int i) {
		...
		result.setColor(Color.alpha(col), Color.red(col), Color.green(col), Color.blue(col)); //TODO
